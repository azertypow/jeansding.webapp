<template>
  <div class="v-app-header">
    ...
    <div class="v-app-header__title">
      <router-link v-if="stateStore.device !== 'mobile'" to="/"       class="v-app-header__title__left jd-font-xl">Inventory</router-link>
      <div                      class="v-app-header__title__center jd-font-xxl">Jeansdinge</div>
      <router-link v-if="stateStore.device !== 'mobile'" to="/projects"  class="v-app-header__title__right jd-font-xl">Projects</router-link>
      <div
